...
public class Reagrupa {
	...
	public Reagrupa(final MatriuDistancies md, final tipusDades typeData,
		...
		this.mdAct = md;
//		System.out.println("into reagrupa");
		this.IniciaDades();
	}

	private void IniciaDades() {
//		System.out.println("into IniciaDades");
...
//		System.out.println("into rg.recalula()");
		Integer grupActual;
		int numElements;
		double dist;
...
//		System.out.println("Through recalcula for loops");
...
//		System.out.println("into rg.NovaMatriu()");
...
//			System.out.println("Name: " + c.getNom());
//			System.out.println("Elements: " + c.getCardinalitat());
//			System.out.println();
...
//		System.out.println("pass up to initializating new matrix");
